...
final class AgentChatSessionRegistry {
    ...
    ///   - agentReportActiveEntryReader: Optional authority-preserving reader
    ///     used by Agent Report capture.
    ///   - agentReportAuthorityPublicationGate: Optional test gate before a
    ///     resolved Agent Report authority is published.
    init(
