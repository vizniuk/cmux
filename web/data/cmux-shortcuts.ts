...
export const shortcutCategories: ShortcutCategory[] = [
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { id: "copyAgentReport", combos: [["⌘", "⇧", "C"]], description: { en: "Copy Agent Report", ja: "エージェントレポートをコピー" } },
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { id: "clearAllNotifications", combos: [], description: { en: "Clear all notifications", ja: "すべての通知を消去" }, note: { en: "unbound by default", ja: "デフォルトでは未割り当て" } },
